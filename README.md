...
* **Lucky One**: Aumenta en **+1 todas las probabilidades del juego**. Al puntuar 5 Tréboles (*Clubs*), almacena **1 Tirada Asegurada (100% de éxito garantizado)**, acumulable hasta un máximo de **5 activaciones**. Gana **+X0.1 Multi** de forma permanente cada vez que una probabilidad tiene éxito (inicia en **X1.5 Multi**).
