...
### 💼 Cartas y Sobres de Trabajo (Job Cards & Applications)
Un nuevo tipo de consumibles temáticos que asignan oficios permanentes o aplican mejoras exclusivas a tus cartas:
- **Sobres**: *Job Application*, *Jumbo Job Application*, *Mega Job Application*.
- **Oficios y Efectos**:
  - **The Miner**: Mejora 1 carta a *Diamond Card*.
  - **The Gardener**: Añade +2 Fichas base permanentes a todas las cartas de su palo al descartarse.
  - **The Banker**: Mejora 1 carta a *Investment Card* (genera interés al final de ronda).
  - **The Surgeon**: Destruye la 1ª carta y transfiere Fichas base, mejoras, sellos y ediciones a la 2ª.
  - **The Alchemist**: Mejora 1 carta a *Lead Card* (se transmuta a Carta de Oro al vencer ciegas).
  - **The Butcher**: Destruye 1 carta de rango 4+ y crea 2 cartas de la mitad de su valor con mejoras aleatorias.
  - **The Detective**: Si está en la mano inicial, revela las 3 próximas cartas y les otorga Sellos Dorados o Azules.
...
### 🎫 Vales (Vouchers)
- **Catador (Taster)**: Los Jokers Comunes aparecen con menor frecuencia en la tienda.
- **Crítico (Critic)**: Requiere Catador. Los Jokers Comunes dejan de aparecer completamente en la tienda.
...
2. Descarga la carpeta `Cracklatro` o el archivo `.zip` del release.
